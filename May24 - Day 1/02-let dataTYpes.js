// LET - Integer
let mobileNUmber = 9884989011;
console.log("Integer Value is : " +mobileNUmber);
console.log(typeof mobileNUmber);

// LET - Decimal Value
let rateOfInterest = 7.5;
console.log("Decimal Value is : " +rateOfInterest);
console.log(typeof rateOfInterest);

// LET - String - Using Nos
let landLineNo = "123456789";
console.log("String Value is : " +landLineNo);
console.log(typeof landLineNo);

// LET - String - Using text
let compName = 'Test Leaf';
console.log("String Value is : " +compName);
console.log(typeof landLineNo);

// LET - Big INT ( When n is there at the last it will identify it as Big Int )
let population = 1232323232323232232333244n;
